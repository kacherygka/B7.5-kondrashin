...
while True:
    ...
    player.random()
    print_boards()
    print("Если вас не устраивает расположение вашего поля нажмите ENTER для генерации нового (random).")
...
while game:
    ...
    while guessing:
        ...
        guess_x = input("Выберите столбик для стрельбы: ")
        guess_y = input("Выберите клетку для стрельбы: ")
